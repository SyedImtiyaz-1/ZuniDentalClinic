  ...
  <link rel="shortcut icon" href="/favicon.ico" />
      ...
      <body className={`${geistSans.variable} ${geistMono.variable} antialiased min-h-screen flex flex-col`}>
        ...
        <div id="whatsapp-widget" className="fixed bottom-6 right-6 z-50">
          <div className="bg-white rounded-2xl p-3 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 cursor-pointer group">
            <div className="flex items-center justify-center">
              <div className="w-12 h-12 bg-green-500 rounded-full flex items-center justify-center shadow-lg group-hover:bg-green-600 transition-colors">
